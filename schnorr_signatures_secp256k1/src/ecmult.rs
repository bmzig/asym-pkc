...
impl AffinePoint {
    ...
    /// In this update, I replace the double and add algorithm with windowed-non-adjacent-form, or
    /// wNAF for short, for elliptic curve multiplication. On average, this takes ~17% less
